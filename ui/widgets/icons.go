...
func MaterialIcons(name string, theme *hakoniwatheme.Theme) material.LabelStyle {
...
var EditorFormatListNumberedIcon *widget.Icon = func() *widget.Icon {
	icon, _ := widget.NewIcon(icons.EditorFormatListNumbered)
	return icon
}()

var EditorShortText *widget.Icon = func() *widget.Icon {
	icon, _ := widget.NewIcon(icons.EditorShortText)
	return icon
}()
